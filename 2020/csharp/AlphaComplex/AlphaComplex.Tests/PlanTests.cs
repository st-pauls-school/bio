...
namespace AlphaComplex.Tests
{
    ...
    public class PlanTests
    {
        ...
        {
            Plan p = new Plan("EAED");
            CollectionAssert.AreEqual(new List<string> { "CE", "E", "A", "EF", "ABD", "D" }, p.Connections);
        }
        ...
        public void TestGiven()
        {
            Plan p = new Plan("EAED");
            CollectionAssert.AreEqual(new List<string> { "CE", "E", "A", "EF", "ABD", "D" }, p.Connections);
            Assert.AreEqual("C", p.Moves(1));
            Assert.AreEqual("A", p.Moves(2));
        }

        [TestMethod]
        public void TestMarkScheme1()
        {
            Plan p = new Plan("A");
